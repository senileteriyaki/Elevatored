...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    frc.robot.util.PhoenixUtil.tryUntilOk(5, () -> cancoder.getConfigurator().apply(cancoderConfig));
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(
        Drive.ODOMETRY_FREQUENCY_Hz, drivePosition, turnPosition);
    BaseStatusSignal.setUpdateFrequencyForAll(
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    // Update turn inputs
    inputs.steerConnected = turnConnectedDebounce.calculate(turnStatus.isOK());
    inputs.steerAbsConnected = turnEncoderConnectedDebounce.calculate(turnEncoderStatus.isOK());
    inputs.steerAbsPos_Rot2d = Rotation2d.fromRotations(turnAbsolutePosition.getValueAsDouble());
    inputs.steerPos_Rot2d = Rotation2d.fromRotations(turnPosition.getValueAsDouble());
    inputs.steerVel_rps = turnVelocity.getValueAsDouble();
    inputs.steerVolts_V = turnAppliedVolts.getValueAsDouble();
    inputs.steerCurrent_A = turnCurrent.getValueAsDouble();
    ...
    inputs.odometryDrivePos_r =
        drivePositionQueue.stream()
            .mapToDouble((Double value) -> value) // TODO: Check if efficient
            .toArray();
    inputs.odometrySteerPos_Rot2d =
